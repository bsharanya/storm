...
public class GlobalStatistics {
    ...
    public GlobalStatistics(Map conf) {
        ...
        topologyStatistics = new HashMap<>();
        transferStatsTable = new HashMap<>();
        emitStatsTable = new HashMap<>();
        emitRatesTable = new HashMap<>();
        executeStatsTable = new HashMap<>();
        executeRatesTable = new HashMap<>();
    }
